...
public class Client {
    public static void main(String[] args) throws IOException,ClassNotFoundException{
        ...
        CommandPackage firstset = new CommandPackage("Vehicle.csv",true);
        ...
        set:while(selector.select() > 0){
            ...
            while (iterator.hasNext()){
                ...
                if(selectionKey.isReadable()){
                    ...
                    CollectionsofVehicle.setVehicle(firstResopne.getVehicle());
        ...
        for(Vehicle P: new CollectionsofVehicle().getVehicle()){
            ...
            if (selector.select() > 0) {
                ...
                while (iterator.hasNext()) {
                    ...
                    if (key.isWritable()) {
                            ...
                            if ((abstractCommand = commandIterator.next()).getName().equalsIgnoreCase(commarg[0])) {
                                ...
                                try {
                                    ...
                                    if (!command.getName().equalsIgnoreCase("executeScript")) {
                                        ...
                                        commandPackage = packcommand(commarg, commandManager, commandPackage, command,"Vehicle.csv");
                        ...
                        Vehicle.setIdcode(response.getId());
    ...
    public static CommandPackage packcommand(String [] commarg,CommandManager commandManager,CommandPackage commandPackage,AbstractCommand command,String FileName) throws IOException,ParaInapproException{
        if (commarg.length == 2) {
            ...
            if (commarg[0].equalsIgnoreCase("Removebyid")) {
                try {
                    Vehicle P = commandManager.findByid(Integer.valueOf(commarg[1]));
                ...
                Vehicle P = commandManager.findByid(Integer.valueOf(commarg[1]));
                commandPackage = new CommandPackage(command, P,FileName);
            }//for command removefuelType
            else if (commarg[0].equalsIgnoreCase("removefuelType")) {
                LinkedHashSet<Vehicle> linkedHashSet = commandManager.findbyEye(commarg[1]);
                ...
                Vehicle after = Vehicle.vehiclecreate();
                Vehicle.balaceicode();
                String[] I = {commarg[1]};
            ...
            String [] acceptone = {"Removegreater","Removebyid","updateid","removefuelType"};
            ...
            if (commarg[0].equalsIgnoreCase("add") || commarg[0].equalsIgnoreCase("addifmin")) {
                Vehicle P = Vehicle.vehiclecreate();
                commandPackage = new CommandPackage(command, P,FileName);
            } else {
                commandPackage = new CommandPackage(commarg, command,FileName);
            }
